  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>WAN Technologies</span></h2>
            <p>A wide area network (WAN) is a network that covers a broad area (i.e., any telecommunications network that links across metropolitan, regional, or international boundaries) using leased telecommunication lines. Business and government entities utilize WANs to relay data among employees, clients, buyers, and suppliers from various geographical locations. In essence, this mode of telecommunication allows a business to effectively carry out its daily function regardless of location. The Internet can be considered a WAN as well, and is used by businesses, governments, organizations, and individuals for almost any purpose imaginable.</p>
            <div class="clr"></div>
            <p class="post-data">&nbsp;</p>
            <div class="clr"></div>
          </div>
        ...
        <div class="sidebar">
          <div class="gadget">
            ...
            <div class="clr"></div>
              ...
              <li class="active"><a href="wan.php"> >>WAN Technologies</a></li>
              <li></li>
            </ul>
          </div>
          <div class="gadget">
