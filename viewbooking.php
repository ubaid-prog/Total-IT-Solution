...
$result = mysqli_query($con,"SELECT * FROM booking WHERE `uname` = '$_SESSION[username]'");
...
<?php
		...
		$result1 = mysqli_query($con,"SELECT sum(price) FROM booking WHERE `uname` = '$_SESSION[username]'");
		
		while ($rows = mysqli_fetch_array($result1)) {
	?>
	
		
			<p id="total"><b>&nbsp;Total Price:&nbsp;</b> £<?php echo $rows['sum(price)']; ?>
		<a href="https://www.paypal.com/uk/cgi-bin/webscr?cmd=_login-run"><input type="button" value="CheckOut" /></a></p>
	<a href="coursesbooking.php"><b>>>Back to Home </b> </a>
	<?php }
