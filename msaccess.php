        ...
        <div class="sidebar">
          <div class="gadget">
            ...
            <div class="clr"></div>
              ...
              <li class="active"><a href="msaccess.php"> >>Introduction to Microsoft Access</a></li>
