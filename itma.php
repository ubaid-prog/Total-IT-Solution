  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>Database Design Course Booking  </span></h2>
            <div id="user">
            <?php 
...
?>
	...
	$results = $mysqli->query("select * from courses where `ctitle` = 'Introduction to Microsoft Access'");
	...
	$results1 = $mysqli->query("select coursedate from coursedates where `courseid` = '6' ");
    if ($results) { 
