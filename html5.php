  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>Web Development Course Booking  </span></h2>
            <div id="user">
            <?php 
...
?>
	...
	$results = $mysqli->query("select * from courses where `ctitle` = 'Introduction to HTML 5'");
	...
	$results1 = $mysqli->query("select coursedate from coursedates where `courseid` = '5' ");
    if ($results) { 
